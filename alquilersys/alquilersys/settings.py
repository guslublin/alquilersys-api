"""
Django settings for alquilersys project.
...
SECRET_KEY = 'django-insecure-_*+3-pipmqbsuinkb=hoc1md1zqql=0lkj8l%5r*h6670_q!qw'
...
WSGI_APPLICATION = 'alquilersys.wsgi.application'
